...
<div class="page">
    ...
    <div class="bar">
        <div>
            <h2>Student Result Sheet <span class="badge">{{ $student->room->name ?? 'N/A' }}</span></h2>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if(!empty($val->teacher))
                                <div class="muted">
                                    Teacher: {{ $val->teacher->first_name ?? '' }} {{ $val->teacher->last_name ?? '' }}
                                </div>
                            @endif
                        </td>
                        <td class="t-center">{{ $examName }}</td>
                        <td class="t-center">{{ $val->marks_obtained ?? '-' }}</td>
                        <td class="t-center">{{ $val->grade ?? '-' }}</td>
                        <td class="t-center">{{ number_format($val->gpa ?? 0, 2) }}</td>
                    </tr>
                @endforeach
