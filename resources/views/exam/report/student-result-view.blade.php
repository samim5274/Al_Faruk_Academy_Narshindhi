            ...
            <div class="page-header mb-6">
                <div class="page-block">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Student Result Sheet</li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <table class="table table-sm mb-0 align-middle">
                                                <tbody>
                                                    @foreach($exam['subjects'] as $subject)
                                                        @php
                                                            $m = $subject['marks'];
                                                            $isFail = is_numeric($m) && $m < 40;
                                                        @endphp
                                                        <tr>
                                                            <td class="px-3 py-2">
                                                                <span class="text-dark fw-semibold">{{ $subject['subject'] }}</span>
                                                            </td>
                                                            <td class="px-3 py-2 text-end" style="width: 90px;">
                                                                @if($m !== null)
